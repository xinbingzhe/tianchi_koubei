...
way1 = 'r'
road3 = "e:/tianchi_koubei/result/ext_result5_7days_11_3.0.csv"
way2 = 'w'
...
while i<2000:
    ...
    params_ext = {'max_features':'log2','n_estimators':600,'max_depth':10,'oob_score': True, 'n_jobs':4,'bootstrap':True}
    ext = ExtraTreesRegressor(**params_ext)
    ext.fit(x_train,y_train)
    y_pre_ext1 = ext.predict(x_test)
    y_pre_ext2 = y_pre_ext1
    y_pre_ext = np.append(y_pre_ext1,y_pre_ext2)
    y_pre_ext[10] = y_pre_ext[10]*1.1
    ###
    '''
